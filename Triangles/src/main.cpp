...
int main() {
    ...
    // Colors
    SDL_Color blue{8, 61, 119, 255};
    SDL_Color green{38, 125, 57, 255};
    SDL_Color red{221, 49, 46, 255};

    // Triangles
    SDL_Vertex v1{1000, 100};
    SDL_Vertex v2{1000, 600};
    SDL_Vertex v3{500, 600};
    Polygon triangleA({v1, v2, v3}, blue);
    v1 = {100, 100};
    v2 = {100, 600};
    v3 = {200, 600};
    Polygon triangleB({v1, v2, v3}, green);


    std::array<bool, (int)PressedKey::COUNT> pressedKeyArray;
